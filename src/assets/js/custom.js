...
======================================*/
  ...
  function makeTimer() {
    ...
    $("#days").html(days + '<span className="camp">Days</span>');
    $("#hours").html(hours + '<span className="camp">Hour</span>');
    $("#minutes").html(minutes + '<span className="camp">Minute</span>');
    $("#seconds").html(seconds + '<span className="camp">Second</span>');
  }
