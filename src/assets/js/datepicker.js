...
(function (global, factory) {
  ...
  var DEFAULTS = {
    ...
    template:
      ...
      '<div className="datepicker-panel" data-view="years picker">' +
      "<ul>" +
      ...
      "</div>" +
      '<div className="datepicker-panel" data-view="months picker">' +
      "<ul>" +
      ...
      "</div>" +
      '<div className="datepicker-panel" data-view="days picker">' +
      "<ul>" +
